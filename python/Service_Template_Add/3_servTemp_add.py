...
servTemp_name = input("What is the Service Template name? ")

print_statement(servTemp_print)
servTemp_option = input("Please enter Template type (1-5): ")

csv_batch_file = input("What is the full batch file name? ")
