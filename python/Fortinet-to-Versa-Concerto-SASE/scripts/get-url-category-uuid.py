...
FINAL_DATA_FILE = os.path.join(_BASE_DIR, "final-data", "final-custom-urlf-profile.txt")
GENERAL_FILE = os.path.join(_BASE_DIR, "temp", "general.txt")
LOG_FILE = os.path.join(_BASE_DIR, "log", "step-get_urlf_uuid.log")
